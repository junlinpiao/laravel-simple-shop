...
<head>
    ...
    <meta name="keywords" content="shop, shopping, ecommerce, html">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language asdf">
            ...
            <div class="header__top__right__auth">
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>"><i class="fa fa-user"></i><?php echo e(__(' Login')); ?></a>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="<?php echo e(route('home')); ?>" method="GET">
                                ...
                                <input name="searchkey" type="text" placeholder="What do yo u need?" value="<?php echo e($searchkey ?? ''); ?>" >
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="<?php echo e(route('home')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <label for="image_file"><strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17" style="margin-right: 10px;"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> Choose an image</strong><span class="input_filename"></span></label>
                                <input type="file" name="image_file" id="image_file" class="inputfile" accept="image/*" data-multiple-caption="{count} files selected" multiple required />
                                <button type="submit" class="site-btn">SEARCH</button>
                            </form>
                        </div>
                    </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
    ...
    <script src="<?php echo e(asset('js/jquery.custom-file-input.js')); ?>"></script>
